...
export default function AudiencePage({ eyebrow, title, intro, bullets, cta }: AudiencePageProps) {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    setSubmitError("");
    try {
      const response = await fetch("/api/waitlist", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ email: email.trim(), audience, company }) });
